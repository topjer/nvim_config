return {
  {
    ...
    config = function ()
      ...
      local python = Terminal:new({cmd = "python", direction="float", id = 2, display_name = "python", autochdir = true})
      local standard = Terminal:new({ direction="float", id = 1, display_name = "standard", autochdir = true})
      ...
      local function _advent_of_code_run_solution()
        ...
        _standard_toggle()
        vim.cmd('TermExec direction=float cmd="clear && python solution.py"')
        -- vim.cmd('TermExec direction=float cmd="cd '.. current_dir .. ' && clear && python solution.py"')
      end
      ...
      local function _advent_of_code_run_pytest()
        ...
        vim.cmd('TermExec direction=float cmd="clear && pytest -s solution.py"')
      end
